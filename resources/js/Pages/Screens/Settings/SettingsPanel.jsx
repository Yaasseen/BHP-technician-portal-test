...
import { InputNumber, Input, Button, Table, Select, message, Spin, Card } from "antd";
import { SaveOutlined, SyncOutlined, ApiOutlined } from "@ant-design/icons";
...
const SettingsPanel = () => {
    ...
    const fetchSettings = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                setOdataUrl(data.bc_odata_base_url || "");
                setSoapUrl(data.bc_soap_base_url || "");
                setInstanceName(data.bc_instance_name || "");
            })
    ...
    const handleSaveConnection = () => {
        ...
        axios
            .put("/app-settings/connection", {
                bc_odata_base_url: odataUrl || null,
                bc_soap_base_url: soapUrl || null,
                bc_instance_name: instanceName || null,
            })
            .then((res) => {
                messageApi.success(res.data.message || "Connection settings saved.");
            })
            .catch((error) => {
                messageApi.error(
                    error.response?.data?.error || "Failed to save connection settings."
                );
            })
    ...
    return (
        <div className="flex flex-col gap-6 w-full max-w-3xl">
            ...
            <Card className="rounded-2xl shadow-sm" title="Business Central Connection">
                <p className="text-xs text-gray-500 mb-4">
                    Overrides the ODATA_BASE_URL / SOAP_BASE_URL / BC_INSTANCE_NAME
                    values from .env. Leave a field blank to fall back to .env.
                ...
                <div className="flex flex-col gap-4">
                    <div>
                        ...
                        <Input
                            ...
                            placeholder="e.g. https://uatcentral.cloud24.mu:9058"
                        />
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-700 mb-1">
