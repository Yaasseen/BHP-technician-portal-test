    ...
    return (
        <div className="pt-5">
            ...
            <div className="form-container sm:p-5 bg-white ">
                <h2 className="font-extrabold text-xl pb-5 border-b border-slate-100 text-slate-900 border-l-4 border-red-500 pl-4 h-8 flex items-center">
                    Assign Team
                </h2>
                <Form
                    form={form}
                            ...
                            <div className="flex justify-end">
                                <Form.Item>
                                    ...
                                    <Button
                                        type="primary"
                                        htmlType="submit"
                                        className="bg-red-600 border-none hover:bg-red-700 h-10 font-bold shadow-md shadow-red-100 px-6"
                                    >
                                        {submitLoading ? (
