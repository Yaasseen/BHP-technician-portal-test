...
const Sidebar = ({ user, activeView, setActiveView }) => {
    return (
        <aside className="hidden sm:flex flex-col w-60 h-screen fixed left-0 top-0 bg-white border-r border-gray-200 z-40">
            <div className="px-5 py-5 border-b border-gray-100">
                <p className="text-xl font-black text-red-600 tracking-tight">
                    TBH<span className="text-slate-900"> Portal</span>
                </p>
            </div>
