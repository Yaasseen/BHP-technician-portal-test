        ...
        <>
            ...
            <div className="pt-5">
                <div className="form-container sm:p-5 bg-white">
                    <h2 className="font-extrabold text-xl pb-5 border-b border-slate-100 text-slate-800 border-l-4 border-l-red-500 pl-4 h-8 flex items-center">
                        Scheduled Visit
                    </h2>
                    <Form
                        form={form}
                    ...
                    >
                        ...
                        <div className="flex justify-end">
                            <Button
                                type="primary"
                                htmlType="submit"
                                className="bg-red-600 border-none hover:bg-red-700 h-10 font-bold shadow-md shadow-red-100 flex items-center justify-center p-6"
                            >
                                {submitLoading ? (
