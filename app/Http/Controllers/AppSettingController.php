...
class AppSettingController extends Controller
{
    ...
    public function updateConnection(Request $request)
    {
        ...
        $validated = $request->validate([
            'bc_odata_base_url' => 'nullable|string|max:255',
            'bc_soap_base_url' => 'nullable|string|max:255',
            'bc_instance_name' => 'nullable|string|max:255',
        ]);
        ...
        return response()->json([
            'message' => 'Business Central connection settings updated. Takes effect on the next request.',
            'data' => $settings->fresh(),
        ], 200);
    }
}
